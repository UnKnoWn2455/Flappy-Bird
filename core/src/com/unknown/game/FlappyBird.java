...
public class FlappyBird extends ApplicationAdapter {
    ...
    BitmapFont font;
    int gameState = 0;
    float gravity = 2; // Adjust gravity to increase falling speed of the bird
    Texture topTube;
    Texture bottomTube;
    float gap = 450;
    float maxTubeOffset;
    ...
    public void startGame() {
        ...
        for (int i = 0; i < numberOfTubes; i++) {
            ...
            // Set initial tubeX positions to start at the right edge of the screen
            tubeX[i] = Gdx.graphics.getWidth() - topTube.getWidth() + i * distanceBetweenTheTube;
    ...
    public void render() {
        ...
        if (gameState == 1) {
            if (tubeX[scoringTube] < 0) { // Changed condition to check against the left edge
                score++;
            ...
            for (int i = 0; i < numberOfTubes; i++) {
                if (tubeX[i] < -topTube.getWidth()) {
                    ...
                    // Move the tube towards the left edge of the screen
